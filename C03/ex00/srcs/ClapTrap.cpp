...
{
	std::cout << B "Default constructor called" RS << std::endl;
	return ;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0)
{
	std::cout << B "String constructor called" RS << std::endl;
	return ;
}

ClapTrap::~ClapTrap()
{
	std::cout << B "Destructor called" RS << std::endl;
	return ;
}
...
{
	std::cout << B "Copy constructor called" RS << std::endl;
	return ;
}
...
void	ClapTrap::attack(const std::string& target)
{
	...
	{
		this->_energyPoints--;
		std::cout	<< G "ClapTrap " RS << this->_name
					<< G " attacks " RS << target
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	if (this->_hitPoints > 0)
	{
		...
		std::cout	<< Y "ClapTrap " RS << this->_name
					<< Y " loses " RS << amount
					<< Y " hits point." RS << std::endl;
		if (this->_hitPoints <= 0)
		{
			std::cout	<< R "ClapTrap " << this->_name
						<< " Dies" RS << std::endl;
		}
	}
	else
